    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <div id="frmCheckUsername">
                ...
                <p><?php echo $lang['RPW_MESSAGE']; ?></p>

                <div class="form-group">
                    <input type="email" class="demoInputBox" size="55" name="email" id="email" placeholder="<?php echo $lang['PH_EMAIL']; ?>">
                </div>

                <input type="submit" name="reset_pwd_submit" class="btn btn-primary" value="<?php echo $lang['BUTTON_NEXT']; ?>">
